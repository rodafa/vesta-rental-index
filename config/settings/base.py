...
LEADSIMPLE_APPLICATION_PROCESS_TYPE_ID = os.environ.get(
    "LEADSIMPLE_APPLICATION_PROCESS_TYPE_ID",
    "c9927e92-5c41-4c33-8a9e-8dbd6312eeb6",
)
LEADSIMPLE_APPLICATION_ENTRY_STAGE_ID = os.environ.get(
    "LEADSIMPLE_APPLICATION_ENTRY_STAGE_ID",
    "c2978ed1-c104-4356-98ea-a70b0d5d63ab",
)
...
SLACK_SHOWING_MAINTENANCE_WEBHOOK_URL = os.environ.get("SLACK_SHOWING_MAINTENANCE_WEBHOOK_URL", "")
...
RENTVINE_WEBHOOK_URL_SECRET = os.environ.get("RENTVINE_WEBHOOK_URL_SECRET", "")
